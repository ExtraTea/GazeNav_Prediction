...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='trained_models/my_model_with_360fov')
	...
	parser.add_argument('--test_model', type=str, default='00200.pt')
	...
	if test_args.visualize:
		...
		ax.set_xlim(-6.5*scale, 6.5*scale) # 6
		ax.set_ylim(-6.5*scale, 6.5*scale)
