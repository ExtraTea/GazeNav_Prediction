...
from crowd_sim.envs.utils.states import ObservableState, FullState
from crowd_sim.envs.utils.actions import ActionXY, ActionRot

class Agent(object):
    def __init__(self, config, section):
        subconfig = config.robot if section == 'robot' else config.human
        ...
        self.policy = ORCA(config)
        self.sensor = subconfig.sensor
        self.fov = np.pi * subconfig.fov

        self.kinematics = 'holonomic' if section == 'human' else config.action_space.kinematics
        self.px = None
        self.py = None
        self.gx = None
        self.gy = None
    ...
    def set(self, px, py, gx, gy, vx=0, vy=0, theta=None, radius=None, v_pref=None):
        self.px = px
        self.py = py
        self.gx = gx
        self.gy = gy
    ...
    def set_list(self, px, py, gx, gy, vx, vy, theta, radius, v_pref):
        self.px = px
        self.py = py
        self.gx = gx
        self.gy = gy
